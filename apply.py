...
def process_closures(details: CompanyDetails, cl_path: Path, res_path: Path):
  ...
  product = input("Provide a new product launched by the company: product name: ")
...
def add_company():
  ...
  details = CompanyDetails(
    ...
    recruiters_name=input("Recruiter's name [Hiring Manager]: ").strip() or "Hiring Manager",
